...
class AdminClass:
    ...
    def adminwindow(self):
        ...
        informationEmployee = Button(adminmainwindow, text = 'All Employee information', command = self.EmployeeAllInformationWindow, bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        informationEmployee.pack(fill=X)

        LeaveListButton = Button(adminmainwindow, text = 'Leave approval list', command = self.leavelist, bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        LeaveListButton.pack(fill=X)

        ApprovalButton = Button(adminmainwindow, text = 'Approve leave', command = self.LeaveApproval, bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        ApprovalButton.pack(fill=X)

        LogoutBtn = Button(adminmainwindow, text = 'Logout', command = adminmainwindow.destroy, bd=12, relief=GROOVE, fg="red",bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
...
class EmployeeClass:
    ...
    def EmployeeLoginWindow(self):
        ...
        informationEmployee = Button(LoginWindow, text = 'Employee information', command = self.EmployeeInformationWindow, bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        informationEmployee.pack(fill=X)

        submit = Button(LoginWindow, text = 'Submit Leave', command = self.apply, bd=12, relief = GROOVE, fg = "black", bg = "lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        submit.pack(fill=X)

        LeaveBalance = Button(LoginWindow, text= 'Leave Balance', command = self.balance, bd = 12, relief = GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        LeaveBalance.pack(fill=X)

        LeaveApplicationStatus = Button(LoginWindow, text= 'Last leave status', command = self.EmployeeLeaveStatus, bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        LeaveApplicationStatus.pack(fill=X)

        AllLeaveStatus = Button(LoginWindow, text='All leave status', command = self.EmployeeAllStatus, bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        AllLeaveStatus.pack(fill=X)

        LogoutBtn = Button(LoginWindow, text = 'Logout', command = self.Employeelogout, bd=12, relief=GROOVE, fg="red", bg="lightpink", font=("Calibri", 36, "bold"), activebackground = "lightpink")
        LogoutBtn.pack(fill=X)
...
class update_info_class:
    ...
    def UpdateWindow(self):
        ...
        informationEmployee = Button(UpdateWindow, text = 'Employee information', command = self.Employee_Information_Window, bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        informationEmployee.pack(fill=X)

        updatename = Button(UpdateWindow, text = 'Update Name', command= self.update_name, bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        updatename.pack(fill=X)

        updatephonenumber = Button(UpdateWindow, text = 'Update Phone Number', command = self.update_Phone_Number, bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        updatephonenumber.pack(fill=X)

        changepassword = Button(UpdateWindow, text = 'Change Password', command = self.change_password, bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        changepassword.pack(fill=X)
        
        updatemail = Button(UpdateWindow, text = 'Update Mail ID', command = self.update_Emp_mail, bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        updatemail.pack(fill=X)

        updateaddress = Button(UpdateWindow, text = 'Update Address', command = self.update_Emp_address, bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), activebackground = "lightpink")
        updateaddress.pack(fill=X)

        LogoutBtn = Button(UpdateWindow, text = 'Logout', command = self.Employeelogout, bd=12, relief=GROOVE, fg="red", bg="lightpink", font=("Calibri", 36, "bold"), activebackground = "lightpink")
        LogoutBtn.pack(fill=X)
...
def mainwindow():
    ...
    MainLabel = Label(root, text="Employee Leave Management System", bd=12, relief=GROOVE, fg="Black", bg="lightpink",font=("Calibri", 60, "bold"))
    MainLabel.pack(fill=X)

    AdminLgnBtn = Button(root, text='HR login',  bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), command=obj5.HRLogin, activebackground = "lightpink")
    AdminLgnBtn.pack(fill=X)

    AdminLgnBtn = Button(root, text='Dean login',  bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), command=obj1.AdminLogin, activebackground = "lightpink")
    AdminLgnBtn.pack(fill=X)

    # HRLgnBtn = Button(root, text='HR login',  bd=12, relief=GROOVE, fg="black", bg="lightpink",font=("Calibri", 36, "bold"), command = HRLogin, activebackground = "lightpink")
    # HRLgnBtn.pack(fill=X)

    EmployeeRegistration = Button(root, text='Employee registration', command = obj4.registration, bd=12, relief=GROOVE, fg="black", bg="lightpink", font=("Calibri", 36, "bold"), activebackground = "lightpink")
    EmployeeRegistration.pack(fill=X)

    LoginBtn = Button(root, text='Employee login', bd=12, relief=GROOVE, fg="black", bg="lightpink", font=("Calibri", 36, "bold"), command=obj2.EmployeeLogin, activebackground = "lightpink")
    LoginBtn.pack(fill = X)

    updatebutton = Button(root, text = "Update Information", bd = 12, relief=GROOVE, fg="black", bg="lightpink", font=("Calibri", 36, "bold"), command = obj3.update_information, activebackground = "lightpink")
    updatebutton.pack(fill = X)

    ExitBtn = Button(root, text='Exit', command=root.destroy, bd=12, relief=GROOVE, fg="red", bg="lightpink", font=("Calibri", 40, "bold"), activebackground = "lightpink")
    ExitBtn.pack(fill=X)
